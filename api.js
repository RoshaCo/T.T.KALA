...
(function () {
  ...
  /* =========================================================
     ...
     این بخش از اطلاعات خرید واقعی جداست.
  ========================================================== */
  ...
  /* =========================================================
     ...
     این درخواست فقط اطلاعات واقعی ثبت‌شده
     در سیستم را بررسی می‌کند.
  ========================================================== */
  ...
  /* =========================================================
     ایجاد سفارش
     مبلغ از سمت سایت ارسال نمی‌شود.
     سرور باید مبلغ واقعی محصول را خودش تعیین کند.
  ========================================================== */
  ...
  /* =========================================================
     ...
     کاربر فقط یک شماره وارد می‌کند.
     سرور باید بررسی کند:
     - پرداخت واقعاً موفق بوده
     - سفارش متعلق به همین پرداخت است
     - شماره قبلاً برای همان سفارش ثبت نشده
     - شماره مربوط به سفارش دیگری نباشد
  ========================================================== */
  ...
  /* =========================================================
     ...
     سرور باید قبل از تحویل فایل، خرید موفق را بررسی کند.
  ========================================================== */
