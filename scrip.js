...
function updateLiveStats() {
    ...
    if (participantsEl) participantsEl.textContent = formatNumber(currentParticipants);
    if (purchasesEl) purchasesEl.textContent = formatNumber(currentPurchases);
    if (prizesEl) prizesEl.textContent = formatNumber(currentPrizes);
}
    ...
    if (hasPurchased) {
        ...
        resultHTML = `
            <div style="text-align: center;">
                ...
                <p style="font-size: 14px; margin: 8px 0; color: #00C894;">وضعیت: ثبت شده ✅</p>
        ...
        resultHTML = `
            <div style="text-align: center;">
                ...
                <p style="font-size: 14px; margin: 8px 0; color: #FF6B6B;">وضعیت: هنوز ثبت نشده ❌</p>
                <button onclick="goToProducts()" style="
                    width: 100%;
                    padding: 12px;
                    background: linear-gradient(135deg, #00C894, #00A381);
                    color: white;
                    border: none;
                    border-radius: 12px;
                    cursor: pointer;
...
function showSuccessPage(purchase) {
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <h2 style="font-size: 22px; margin-bottom: 15px; color: #FFD700;">خرید با موفقیت ثبت شد!</h2>
            ...
            <div style="
                ...
                margin: 15px 0;
            ">
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>📦 محصول:</strong> ${purchase.product}</p>
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>💰 مبلغ:</strong> ${faAmount} تومان</p>
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>🔢 شماره خرید:</strong> ${purchase.id}</p>
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>📅 تاریخ:</strong> ${new Date().toLocaleDateString('fa-IR')}</p>
                <hr style="margin: 10px 0; border: 1px solid rgba(255,255,255,0.2);">
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>🎫 کد شرکت:</strong> ${purchase.lotteryNumber}</p>
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>📊 شانس شما:</strong> ۲ عدد</p>
                <p style="margin: 8px 0; font-size: 14px; color: #B8B8D0;"><strong>📱 شماره:</strong> ${faPhone}</p>
                <p style="margin: 8px 0; font-size: 14px; color: #00C894;"><strong>وضعیت:</strong> ثبت قطعی شد ✅</p>
            </div>
