...
(function () {
  ...
  async function lookupChance() {
    ...
    try {
      ...
      /*
       * فقط دو حالت برای کاربر نمایش داده می‌شود:
       *
       * ۱. خریدار و دارای شانس
       * ۲. غیرخریدار و بدون شانس
       */
      ...
      /*
       * خطای فنی با «عدم خرید» اشتباه گرفته نمی‌شود.
       * در صورت خطای واقعی، نتیجه جعلی نمایش داده نمی‌شود.
       */
